    ...
    crate::assert_interpret_only!(
        {
            ...
            class Main {
                fn main(given self) -> Int {
                    let a = array_new[Data](2);
                    array_set[Data](a.mut, 0, new Data(1));
                    array_set[Data](a.mut, 1, new Data(2));
                    a.drop;
                    0;
                }
            }
        ...
        expect_test::expect![[r#"
            ...
            Output: Trace:   let a = array_new [Data](2) ;
            Output: Trace:   a = Array { flag: Given, rc: 1, Data { x: ⚡ }, Data { x: ⚡ } }
            Output: Trace:   array_set [Data](a . mut , 0 , new Data (1)) ;
            Output: Trace:   array_set [Data](a . mut , 1 , new Data (2)) ;
            Output: Trace:   a . drop ;
            Output: Trace:   0 ;
