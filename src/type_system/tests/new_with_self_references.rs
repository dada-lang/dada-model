                                                                                             ...
                                                                                             the rule "my" failed at step #0 (src/file.rs:LL:CC) because
                                                                                               judgment `red_term { a: shared [self . pair] Data, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, choice1: Choice, d1: Data, d2: Data, pair: Pair, r: shared [choice1 . pair . a] Data}, assumptions: {}, fresh: 0 } }` failed at the following rule(s):
                                                                                                 the rule "red term" failed at step #0 (src/file.rs:LL:CC) because
                                                                                                   judgment `ty_chain_of_custody { a: shared [self . pair] Data, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, choice1: Choice, d1: Data, d2: Data, pair: Pair, r: shared [choice1 . pair . a] Data}, assumptions: {}, fresh: 0 } }` failed at the following rule(s):
