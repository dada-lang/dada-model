                                                                     ...
                                                                     the rule "cons" failed at step #6 (src/file.rs:LL:CC) because
                                                                       judgment `sub { a: shared [d3] Data, b: shared [@ fresh(0) . pair] Data, live_after: LivePlaces { accessed: {}, traversed: {} }, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, d1: Data, d2: Data, d3: Data, pair: Pair, r: shared [d3] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                                         the rule "sub" failed at step #0 (src/file.rs:LL:CC) because
                                                                           judgment `sub_under_perms { perms_a: Perms { copied: false, shared_from: {}, leased_from: {}, variables: {} }, a: shared [d3] Data, perms_b: Perms { copied: false, shared_from: {}, leased_from: {}, variables: {} }, b: shared [@ fresh(0) . pair] Data, live_after: LivePlaces { accessed: {}, traversed: {} }, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, d1: Data, d2: Data, d3: Data, pair: Pair, r: shared [d3] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                                             the rule "sub" failed at step #2 (src/file.rs:LL:CC) because
                                                                               judgment `sub_some { lien_data_a: LienData { perms: Perms { copied: true, shared_from: {d3}, leased_from: {}, variables: {} }, data: NamedTy(Data) }, lien_datas_b: {LienData { perms: Perms { copied: true, shared_from: {@ fresh(0) . pair}, leased_from: {}, variables: {} }, data: NamedTy(Data) }}, live_after: LivePlaces { accessed: {}, traversed: {} }, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, d1: Data, d2: Data, d3: Data, pair: Pair, r: shared [d3] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                                                 the rule "sub-some" failed at step #1 (src/file.rs:LL:CC) because
                                                                                   judgment `sub_lien_data { lien_data_a: LienData { perms: Perms { copied: true, shared_from: {d3}, leased_from: {}, variables: {} }, data: NamedTy(Data) }, lien_data_b: LienData { perms: Perms { copied: true, shared_from: {@ fresh(0) . pair}, leased_from: {}, variables: {} }, data: NamedTy(Data) }, live_after: LivePlaces { accessed: {}, traversed: {} }, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, d1: Data, d2: Data, d3: Data, pair: Pair, r: shared [d3] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                                                     the rule "sub-named" failed at step #3 (src/file.rs:LL:CC) because
                                                                                       judgment `sub_perms { perms_a: Perms { copied: true, shared_from: {d3}, leased_from: {}, variables: {} }, perms_b: Perms { copied: true, shared_from: {@ fresh(0) . pair}, leased_from: {}, variables: {} }, live_after: LivePlaces { accessed: {}, traversed: {} }, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, d1: Data, d2: Data, d3: Data, pair: Pair, r: shared [d3] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
