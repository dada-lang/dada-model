                                                                             ...
                                                                             the rule "sub-perms" failed at step #0 (src/file.rs:LL:CC) because
                                                                               judgment `sub_perms { a: ref [d3], b: ref [@ fresh(0) . pair], live_after: LivePlaces { accessed: {}, traversed: {} }, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, d1: Data, d2: Data, d3: Data, pair: Pair, r: ref [d3] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                                                 the rule "dead left" failed at step #1 (src/file.rs:LL:CC) because
                                                                                   judgment `dead_perm { acc: rf, place: d3, tail: my, live_after: LivePlaces { accessed: {}, traversed: {} }, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, d1: Data, d2: Data, d3: Data, pair: Pair, r: ref [d3] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
