                                                                                                 ...
                                                                                                 the rule "is-owned" failed at step #0 (src/file.rs:LL:CC) because
                                                                                                   judgment `prove_predicate { predicate: owned(shared [choice1 . pair]), env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, choice1: Choice, choice1_data: shared [choice1 . pair] Data, choice1_pair: Pair, d1: Data, d2: Data, pair: Pair, r: shared [@ fresh(0) . pair . a] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                                                                     the rule "parameter" failed at step #1 (src/file.rs:LL:CC) because
                                                                                                       condition evaluted to false: `is_true`
                                                                                             the rule "shared-dead" failed at step #1 (src/file.rs:LL:CC) because
                                                                                               judgment `sub_dead_shared { place_a: choice1 . pair, perm_a: RedPerm { perms: [] }, b: RedPerm { perms: [shared [@ fresh(0) . pair]] }, live_after: LivePlaces { accessed: {}, traversed: {} }, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, choice1: Choice, choice1_data: shared [choice1 . pair] Data, choice1_pair: Pair, d1: Data, d2: Data, pair: Pair, r: shared [@ fresh(0) . pair . a] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                                                                 the rule "sub_dead_shared" failed at step #2 (src/file.rs:LL:CC) because
                                                                                                   judgment `prove_is_lent { a: Pair, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, choice1: Choice, choice1_data: shared [choice1 . pair] Data, choice1_pair: Pair, d1: Data, d2: Data, pair: Pair, r: shared [@ fresh(0) . pair . a] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                                                                     the rule "is-lent" failed at step #0 (src/file.rs:LL:CC) because
                                                                                                       judgment `prove_predicate { predicate: lent(Pair), env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my TheClass, @ fresh(0): Choice, choice1: Choice, choice1_data: shared [choice1 . pair] Data, choice1_pair: Pair, d1: Data, d2: Data, pair: Pair, r: shared [@ fresh(0) . pair . a] Data}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                                                                         the rule "parameter" failed at step #1 (src/file.rs:LL:CC) because
                                                                                                           condition evaluted to false: `is_true`
                                                                                             the rule "shared-vs-shared" failed at step #2 (src/file.rs:LL:CC) because
                                                                                               condition evaluted to false: `places_a.iter().all(|place_a|
