                                                         ...
                                                         the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                           judgment `env_permits_access { access: share, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . lease ; let i = foo . i . share ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                             the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `live_variables_permit_access { variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], access: share, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . lease ; let i = foo . i . share ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                 the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [foo : Foo, bar : leased (foo) Foo], access: share, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . lease ; let i = foo . i . share ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [bar : leased (foo) Foo], access: share, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . lease ; let i = foo . i . share ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                       ...
                                                       judgment `access_permitted { access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . lease ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                         the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                           judgment `env_permits_access { access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . lease ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                             the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `live_variables_permit_access { variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . lease ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                 the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [foo : Foo, bar : shared (foo) Foo], access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . lease ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [bar : shared (foo) Foo], access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . lease ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                         the rule "cons, initialized variable" failed at step #2 (src/file.rs:LL:CC) because
                                                       ...
                                                       judgment `access_permitted { access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . give ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                         the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                           judgment `env_permits_access { access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . give ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                             the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `live_variables_permit_access { variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . give ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                 the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [foo : Foo, bar : shared (foo) Foo], access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . give ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [bar : shared (foo) Foo], access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo . share ; let i = foo . i . give ; bar . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                         the rule "cons, initialized variable" failed at step #2 (src/file.rs:LL:CC) because
                                                       ...
                                                       judgment `access_permitted { access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = p . lease ; let r = q . share ; let i = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                         the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                           judgment `env_permits_access { access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = p . lease ; let r = q . share ; let i = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                             the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `live_variables_permit_access { variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = p . lease ; let r = q . share ; let i = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                 the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = p . lease ; let r = q . share ; let i = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [q : leased (p) Foo, r : shared (q) leased (p) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = p . lease ; let r = q . share ; let i = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                         the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                           judgment `live_variables_permit_access { variables: [r : shared (q) leased (p) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = p . lease ; let r = q . share ; let i = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                             the rule "cons, initialized variable" failed at step #2 (src/file.rs:LL:CC) because
                                                           ...
                                                           judgment `access_permitted { access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = p . lease ; let r : shared (q) Foo = q . share ; let i : shared (p . i) Int = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                             the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `env_permits_access { access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = p . lease ; let r : shared (q) Foo = q . share ; let i : shared (p . i) Int = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                 the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = p . lease ; let r : shared (q) Foo = q . share ; let i : shared (p . i) Int = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [p : my Foo, q : leased (p) Foo, r : shared (q) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = p . lease ; let r : shared (q) Foo = q . share ; let i : shared (p . i) Int = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                         the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                           judgment `live_variables_permit_access { variables: [q : leased (p) Foo, r : shared (q) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = p . lease ; let r : shared (q) Foo = q . share ; let i : shared (p . i) Int = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                             the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                               judgment `live_variables_permit_access { variables: [r : shared (q) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = p . lease ; let r : shared (q) Foo = q . share ; let i : shared (p . i) Int = p . i . share ; r . give ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                                 the rule "cons, initialized variable" failed at step #2 (src/file.rs:LL:CC) because
