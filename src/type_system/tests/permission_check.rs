                                                         ...
                                                         the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                           judgment `env_permits_access { access: share, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = lease foo ; let i = foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                             the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `live_variables_permit_access { variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], access: share, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = lease foo ; let i = foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                 the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [foo : Foo, bar : leased (foo) Foo], access: share, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = lease foo ; let i = foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [bar : leased (foo) Foo], access: share, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = lease foo ; let i = foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : leased (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                       ...
                                                       judgment `access_permitted { access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = lease foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                         the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                           judgment `env_permits_access { access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = lease foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                             the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `live_variables_permit_access { variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = lease foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                 the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [foo : Foo, bar : shared (foo) Foo], access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = lease foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [bar : shared (foo) Foo], access: lease, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = lease foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                         the rule "cons, initialized variable" failed at step #2 (src/file.rs:LL:CC) because
                                                       ...
                                                       judgment `access_permitted { access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = give foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                         the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                           judgment `env_permits_access { access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = give foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                             the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `live_variables_permit_access { variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = give foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                 the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [foo : Foo, bar : shared (foo) Foo], access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = give foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [bar : shared (foo) Foo], access: give, place: foo . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let foo = new Foo (22) ; let bar = foo ; let i = give foo . i ; give bar ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, foo : Foo, bar : shared (foo) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {bar} } }` failed at the following rule(s):
                                                                         the rule "cons, initialized variable" failed at step #2 (src/file.rs:LL:CC) because
                                                       ...
                                                       judgment `access_permitted { access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = lease p ; let r = q ; let i = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                         the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                           judgment `env_permits_access { access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = lease p ; let r = q ; let i = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                             the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `live_variables_permit_access { variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = lease p ; let r = q ; let i = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                 the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = lease p ; let r = q ; let i = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [q : leased (p) Foo, r : shared (q) leased (p) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = lease p ; let r = q ; let i = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                         the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                           judgment `live_variables_permit_access { variables: [r : shared (q) leased (p) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = lease p ; let r = q ; let i = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                             the rule "cons, initialized variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                               judgment `ty_permits_access { ty: shared (q) leased (p) Foo, access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = lease p ; let r = q ; let i = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} } }` failed at the following rule(s):
                                                                                 the rule "ty" failed at step #0 (src/file.rs:LL:CC) because
                                                                                   judgment `perm_permits_access { perm: shared (q), access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = lease p ; let r = q ; let i = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} } }` failed at the following rule(s):
                                                                                     the rule "disjoint" failed at step #1 (src/file.rs:LL:CC) because
                                                                                       judgment `perm_places_permit_access { perm_places: {q}, access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p = new Foo (22) ; let q = lease p ; let r = q ; let i = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : Foo, q : leased (p) Foo, r : shared (q) leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} } }` failed at the following rule(s):
...
fn share_field_of_leased_value_but_lease_variable_is_dead_explicit_ty() {
        ...
        "
                ...
                class TheClass {
                    fn empty_method(my self) {
                        ...
                        let q: leased(p) Foo = lease p;
                        let r: shared(q) Foo = share q;
                        let i: shared(p.i) Int = share p.i;
                        give r;
                        ();
                    }
                }
    ...
    .assert_err(expect_test::expect![[r#"
        check program `class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }`

        Caused by:
            0: check class named `TheClass`
            1: check method named `empty_method`
            2: check function body
            3: judgment `can_type_expr_as { expr: { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; }, as_ty: (), env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {} } }` failed at the following rule(s):
                 the rule "can_type_expr_as" failed at step #0 (src/file.rs:LL:CC) because
                   judgment `type_expr_as { expr: { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; }, as_ty: (), env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {} } }` failed at the following rule(s):
                     the rule "type_expr_as" failed at step #0 (src/file.rs:LL:CC) because
                       judgment `type_expr { expr: { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; }, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {} } }` failed at the following rule(s):
                         the rule "block" failed at step #0 (src/file.rs:LL:CC) because
                           judgment `type_block { block: { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; }, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {} } }` failed at the following rule(s):
                             the rule "place" failed at step #0 (src/file.rs:LL:CC) because
                               judgment `type_statements_with_final_ty { statements: [let p : my Foo = new Foo (22) ;, let q : leased (p) Foo = lease p ;, let r : shared (q) Foo = q ;, let i : shared (p . i) Int = p . i ;, give r ;, () ;], ty: (), env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {} } }` failed at the following rule(s):
                                 the rule "cons" failed at step #2 (src/file.rs:LL:CC) because
                                   judgment `type_statements_with_final_ty { statements: [let q : leased (p) Foo = lease p ;, let r : shared (q) Foo = q ;, let i : shared (p . i) Int = p . i ;, give r ;, () ;], ty: (), env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {} } }` failed at the following rule(s):
                                     the rule "cons" failed at step #2 (src/file.rs:LL:CC) because
                                       judgment `type_statements_with_final_ty { statements: [let r : shared (q) Foo = q ;, let i : shared (p . i) Int = p . i ;, give r ;, () ;], ty: (), env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {} } }` failed at the following rule(s):
                                         the rule "cons" failed at step #2 (src/file.rs:LL:CC) because
                                           judgment `type_statements_with_final_ty { statements: [let i : shared (p . i) Int = p . i ;, give r ;, () ;], ty: (), env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {} } }` failed at the following rule(s):
                                             the rule "cons" failed at step #1 (src/file.rs:LL:CC) because
                                               judgment `type_statement { statement: let i : shared (p . i) Int = p . i ;, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                 the rule "let" failed at step #0 (src/file.rs:LL:CC) because
                                                   judgment `type_expr_as { expr: p . i, as_ty: shared (p . i) Int, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                     the rule "type_expr_as" failed at step #0 (src/file.rs:LL:CC) because
                                                       judgment `type_expr { expr: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                         the rule "share|lease place" failed at step #0 (src/file.rs:LL:CC) because
                                                           judgment `access_permitted { access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                             the rule "access_permitted" failed at step #1 (src/file.rs:LL:CC) because
                                                               judgment `env_permits_access { access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                 the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                                   judgment `live_variables_permit_access { variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                     the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                       judgment `live_variables_permit_access { variables: [p : my Foo, q : leased (p) Foo, r : shared (q) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                         the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                           judgment `live_variables_permit_access { variables: [q : leased (p) Foo, r : shared (q) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                             the rule "cons, moved variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                               judgment `live_variables_permit_access { variables: [r : shared (q) Foo], access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} }, live_after: LiveVars { vars: {r} } }` failed at the following rule(s):
                                                                                 the rule "cons, initialized variable" failed at step #2 (src/file.rs:LL:CC) because
                                                                                   judgment `ty_permits_access { ty: shared (q) Foo, access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} } }` failed at the following rule(s):
                                                                                     the rule "ty" failed at step #0 (src/file.rs:LL:CC) because
                                                                                       judgment `perm_permits_access { perm: shared (q), access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} } }` failed at the following rule(s):
                                                                                         the rule "disjoint" failed at step #1 (src/file.rs:LL:CC) because
                                                                                           judgment `perm_places_permit_access { perm_places: {q}, access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} } }` failed at the following rule(s):
                                                                                             the rule "nil" failed at step #1 (src/file.rs:LL:CC) because
                                                                                               judgment `ty_permits_access { ty: leased (p) Foo, access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} } }` failed at the following rule(s):
                                                                                                 the rule "ty" failed at step #0 (src/file.rs:LL:CC) because
                                                                                                   judgment `perm_permits_access { perm: leased (p), access: share, place: p . i, env: Env { program: class Foo { i : Int ; } class TheClass { fn empty_method (Some(my self)) -> () { let p : my Foo = new Foo (22) ; let q : leased (p) Foo = lease p ; let r : shared (q) Foo = q ; let i : shared (p . i) Int = p . i ; give r ; () ; } }, universe: universe(0), in_scope_vars: [], local_variables: [self : my TheClass, p : my Foo, q : leased (p) Foo, r : shared (q) Foo], existentials: [], assumptions: {} }, flow: Flow { moved_places: {} } }` failed at the following rule(s):
                                                                                                     the rule "disjoint" failed at step #0 (src/file.rs:LL:CC) because
                                                                                                       condition evaluted to false: `place_disjoint_from_all_of(&accessed_place, &perm_places)`
                                                                                                         &accessed_place = p . i
                                                                                                         &perm_places = {p}
