                                                 ...
                                                 the rule "cons" failed at step #1 (src/file.rs:LL:CC) because
                                                   judgment `type_statement { statement: bar . i . give ;, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, bar: Foo, foo: Foo, s: shared {bar . i} Data}, assumptions: {}, fresh: 0 }, flow: Flow { moved_places: {foo} }, live_after: LiveVars { vars: {s} } }` failed at the following rule(s):
                                                     the rule "expr" failed at step #1 (src/file.rs:LL:CC) because
                                                       judgment `env_permits_access { access: drop, place: @ in_flight, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, bar: Foo, foo: Foo, s: shared {@ in_flight} Data}, assumptions: {}, fresh: 0 }, flow: Flow { moved_places: {bar . i, foo} }, live_after: LiveVars { vars: {s} } }` failed at the following rule(s):
                                                         the rule "env_permits_access" failed at step #1 (src/file.rs:LL:CC) because
                                                           judgment `parameters_permit_access { parameters: [shared {@ in_flight} Data], access: drop, place: @ in_flight, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, bar: Foo, foo: Foo, s: shared {@ in_flight} Data}, assumptions: {}, fresh: 0 }, flow: Flow { moved_places: {bar . i, foo} } }` failed at the following rule(s):
                                                             the rule "cons" failed at step #0 (src/file.rs:LL:CC) because
                                                               judgment `parameter_permits_access { parameter: shared {@ in_flight} Data, access: drop, place: @ in_flight, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, bar: Foo, foo: Foo, s: shared {@ in_flight} Data}, assumptions: {}, fresh: 0 }, flow: Flow { moved_places: {bar . i, foo} } }` failed at the following rule(s):
                                                                 the rule "ty" failed at step #0 (src/file.rs:LL:CC) because
                                                                   judgment `ty_permits_access { ty: shared {@ in_flight} Data, access: drop, place: @ in_flight, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, bar: Foo, foo: Foo, s: shared {@ in_flight} Data}, assumptions: {}, fresh: 0 }, flow: Flow { moved_places: {bar . i, foo} } }` failed at the following rule(s):
                                                                     the rule "ty" failed at step #0 (src/file.rs:LL:CC) because
                                                                       judgment `perm_permits_access { perm: shared {@ in_flight}, access: drop, place: @ in_flight, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, bar: Foo, foo: Foo, s: shared {@ in_flight} Data}, assumptions: {}, fresh: 0 }, flow: Flow { moved_places: {bar . i, foo} } }` failed at the following rule(s):
