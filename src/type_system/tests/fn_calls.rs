                                                     ...
                                                     the rule "cons" failed at step #4 (src/file.rs:LL:CC) because
                                                       judgment `sub { a: leased {@ fresh(0) . b} Data, b: leased {@ fresh(0) . a} Data, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): Pair, @ fresh(1): leased {@ fresh(0) . b} Data, data: leased {@ fresh(0) . b} Data, pair: Pair}, assumptions: {}, fresh: 2 }, flow: Flow { moved_places: {data, pair} } }` failed at the following rule(s):
                                                         the rule "sub" failed at step #0 (src/file.rs:LL:CC) because
                                                           judgment `sub_cx { liens_a: my, a: leased {@ fresh(0) . b} Data, liens_b: my, b: leased {@ fresh(0) . a} Data, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): Pair, @ fresh(1): leased {@ fresh(0) . b} Data, data: leased {@ fresh(0) . b} Data, pair: Pair}, assumptions: {}, fresh: 2 }, flow: Flow { moved_places: {data, pair} } }` failed at the following rule(s):
                                                             the rule "sub" failed at step #2 (src/file.rs:LL:CC) because
                                                               judgment `sub_ty_liens_sets { ty_liens_a: {NamedTy(leased{@ fresh(0) . b}, Data)}, ty_liens_b: {NamedTy(leased{@ fresh(0) . a}, Data)}, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): Pair, @ fresh(1): leased {@ fresh(0) . b} Data, data: leased {@ fresh(0) . b} Data, pair: Pair}, assumptions: {}, fresh: 2 }, flow: Flow { moved_places: {data, pair} } }` failed at the following rule(s):
                                                                 the rule "cons" failed at step #1 (src/file.rs:LL:CC) because
                                                                   judgment `sub_ty_liens { ty_liens_a: NamedTy(leased{@ fresh(0) . b}, Data), ty_liens_b: NamedTy(leased{@ fresh(0) . a}, Data), env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): Pair, @ fresh(1): leased {@ fresh(0) . b} Data, data: leased {@ fresh(0) . b} Data, pair: Pair}, assumptions: {}, fresh: 2 }, flow: Flow { moved_places: {data, pair} } }` failed at the following rule(s):
                                                                     the rule "named ty" failed at step #3 (src/file.rs:LL:CC) because
                                                                       judgment `sub_liens { a: leased{@ fresh(0) . b}, b: leased{@ fresh(0) . a}, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): Pair, @ fresh(1): leased {@ fresh(0) . b} Data, data: leased {@ fresh(0) . b} Data, pair: Pair}, assumptions: {}, fresh: 2 }, flow: Flow { moved_places: {data, pair} } }` failed at the following rule(s):
