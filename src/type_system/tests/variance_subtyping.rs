                                     ...
                                     the rule "expr" failed at step #3 (src/file.rs:LL:CC) because
                                       judgment `parameter_permits_access { parameter: our Cell[Data], access: drop, place: @ fresh(0), env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): our Cell[Data], d1: our Cell[Data]}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                         the rule "parameter" failed at step #0 (src/file.rs:LL:CC) because
                                           judgment `liens { a: our Cell[Data], env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): our Cell[Data], d1: our Cell[Data]}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                             the rule "my" failed at step #0 (src/file.rs:LL:CC) because
                                               judgment `some_lien { a: our Cell[Data], env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): our Cell[Data], d1: our Cell[Data]}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                 the rule "apply-perm-ty" failed at step #0 (src/file.rs:LL:CC) because
                                                   judgment `some_lien { a: Cell[Data], env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): our Cell[Data], d1: our Cell[Data]}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
                                                     the rule "named" failed at step #1 (src/file.rs:LL:CC) because
                                                       judgment `some_lien { a: Data, env: Env { program: "...", universe: universe(0), in_scope_vars: [], local_variables: {self: my Main, @ fresh(0): our Cell[Data], d1: our Cell[Data]}, assumptions: {}, fresh: 1 } }` failed at the following rule(s):
