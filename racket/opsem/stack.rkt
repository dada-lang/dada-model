...
(define-metafunction Dada
  ...
  [(stack-segments-in-store (Stack-segments _))
   Stack-segments])
...
(define-metafunction Dada
  ...
  [(store-with-stack-segments (Stack-segments_0 Heap-mappings) Stack-segments_1)
   (Stack-segments_1 Heap-mappings)])
...
(define-metafunction Dada
  ...
  [(push-stack-segment ((Stack-segment ...) Heap-mappings))
   (([] Stack-segment ...) Heap-mappings)])
...
(define-metafunction Dada
  ...
  [(pop-stack-segment ((((x Value) ...) Stack-segment_1 ...) Heap-mappings))
   ((Value ...) ((Stack-segment_1 ...) Heap-mappings))])
